...
DOI_BADGE_PATTERN = '<a href="https://doi.org/{0}"><img src="https://zenodo.org/badge/DOI/{0}.svg" width="200"/></a>'
...
class TableEntry:
    ...
    f'<img src="https://github.com/ecocommonsaustralia/notebooks/raw/main/assets/quartomd.png" width="40%"></a>'
        ...
        doi_badge = DOI_BADGE_PATTERN.format(self.doi) if self.doi else ""
