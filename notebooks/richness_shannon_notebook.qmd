...
```
# Step 2: Downloading, loading and preparing data
...
Now we will load in your CSV File (in long format) and check the data structure
...
Reiterate why we are doing Shannon diversity....maybe expand on the Shannon section at the top. Why it compliments ricness!! TODO
