...
options(repr.plot.width = 6, repr.plot.height = 8)  # Sets width to 16 and height to 8 for larger plots
...
```{r landscape descriptive and ttest}
...
shannon_ttest <- t.test(Shannon ~ Landscape, data = shannon_df)
print(shannon_ttest)
```
