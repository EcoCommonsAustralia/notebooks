...
qmd_file <- "/Users/xiangzhaoqcif/dev/notebooks_zhaoxiangmax/notebooks/converting_shapefile_to_geotiff_notebook.qmd"        # Replace with your QMD file path
ipynb_file <- "/Users/xiangzhaoqcif/dev/notebooks_zhaoxiangmax/notebooks/converting_shapefile_to_geotiff_notebook.ipynb"    # Replace with your desired output file path
