...
qmd_file <- "/Users/xiangzhaoqcif/Documents/QCIF_MacBook_Pro/github/notebooks/notebooks/EC_GLM.qmd"        # Replace with your QMD file path
ipynb_file <- "/Users/xiangzhaoqcif/Documents/QCIF_MacBook_Pro/github/notebooks/notebooks/test_GLM.ipynb"    # Replace with your desired output file path
