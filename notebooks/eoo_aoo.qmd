...
For this notebook we are going to use ConR, which includes a EOO.computing and AOO.computing functions to calculate the EOO and AOO for a species. We will also be using the ALA Galah package to access species occurence records.
