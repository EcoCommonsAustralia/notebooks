...
bibliography: reference.bib  # Path to your citation file
...
Author details: Xiang Zhao Editor details: Contact details: support\@ecocommons.org.au Copyright statement: This script is the product of the EcoCommons platform.\
...
-   Data Download: Download continous enviromental datasets from WorldClime. Download categocial environmental dataset from our google drive.

-   Data Processing: Reproject environmental datasets to the crs your desire. Crop and mask enviromental datasets to the extent of your study area. Resample enviromental datasets to a same resolution.
...
## 7. Show Resolution, Extent, and CRS of Raster and Study Are
