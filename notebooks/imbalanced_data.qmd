...
This notebook, developed by the EcoCommons team, showcases how to deal with imbalanced species datasets (presence and absence data) with several methods.
...
3.  Learn how to generate background points using two methods: completely random and buffered-random sampling.
4.  Learn how to compare model performance using different methods for generating background points and pseudo-absence data.
